...
<BaseComponent headline={'Datenschutz'} id={'datenschutz'}>
	<section class="text-justify">
		...
		<h2 class="underline font-bold">Übermittlung von personenbezogenen Daten</h2>
		<p>
		...
		<p>
			...
			die Verarbeitung entsprechend den gesetzlichen Vorgaben im Art. 21 DSGVO einlegen. Nutzer
			können ihren Widerspruch auch über die Einstellungen ihres Browsers erklären, z.B. durch
			Deaktivierung der Verwendung von Cookies (wobei dadurch auch die Funktionalität unserer
		...
		<p>
			...
			wahrnehmen sowie Empfänger von Leistungen und Zuwendungen sind. Im Übrigen verarbeiten wir die
			Daten Betroffener auf Grundlage unserer berechtigten Interessen, z.B. wenn es sich um
		...
		<p>
			...
			Hinblick auf etwaige Gewährleistungs- oder Haftungspflichten auf Grundlage unserer
			berechtigten Interesse an deren Regelung relevant sein können. Die Erforderlichkeit der
		...
		<ul>
			<li>
				...
				oder anderweitig beziehen; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6
			...
			<li>
				...
				<a
					...
					target="_blank"
					rel="noreferrer">https://www.netcup.de/kontakt/datenschutzerklaerung.php</a
		...
		<ul>
			...
			<li>
				<strong>Zwecke der Verarbeitung:</strong> Kontaktanfragen und Kommunikation; Verwaltung und Beantwortung
		...
		<ul>
			<li>
				...
				Platforms Irland Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland;
				<strong>Rechtsgrundlagen:</strong>
			...
			<li>
				<strong>Facebook-Seiten: </strong>Profile innerhalb des sozialen Netzwerks Facebook - Wir
				...
				<a href="https://www.facebook.com/policy" rel="noreferrer" target="_blank"
				...
				>); <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, 4 Grand Canal Square,
				Grand Canal Harbour, Dublin 2, Irland; <strong>Rechtsgrundlagen:</strong> Berechtigte
				...
				<a
					...
					target="_blank"
					rel="noreferrer">https://www.facebook.com/legal/EU_data_transfer_addendum</a
			...
			<li>
				...
				>; <strong>Auftragsverarbeitungsvertrag:</strong>
				<a href="https://legal.linkedin.com/dpa" rel="noreferrer" target="_blank"
			...
			<li>
				...
				Mutterunternehmen: Twitter Inc., 1355 Market Street, Suite 900, San Francisco, CA 94103,
				USA; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
				DSGVO); <strong>Datenschutzerklärung:</strong>
				<a href="https://twitter.com/privacy" rel="noreferrer" target="_blank"

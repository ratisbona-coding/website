...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded fixed z-50 w-full">
	<div class="container flex flex-wrap justify-between items-center mx-auto">
		...
		<div class="hidden w-full md:block md:w-auto" id="navbar-default">
			<ul
				class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white mr-8"
			>
				<li>
					<a
						href="/"
						class="block py-2 pr-4 pl-3 text-green bg-gray-500 rounded md:bg-transparent md:text-black-700 md:p-0 dark:text-white"
